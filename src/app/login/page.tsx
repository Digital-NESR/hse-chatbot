...
export default function LoginPage() {
    return (
        <div className="min-h-[100dvh] w-full flex items-center justify-center bg-gradient-to-br from-slate-950 via-[#162a1e] to-slate-950 relative overflow-hidden">
            ...
            {/* Login Card */}
            <div className="relative z-10 w-full px-4 sm:max-w-sm sm:px-0">
                <div className="bg-slate-900/60 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-6 md:px-8 md:py-10 flex flex-col items-center gap-8">
